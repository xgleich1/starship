...
{
    public sealed class TopRightRcsActivationCommandTest
    {
        [Test]
        public void Should_expose_the_commanded_activated_state()
        {
            // GIVEN
            var commandA = new TopRightRcsActivationCommand(true);
            var commandB = new TopRightRcsActivationCommand(false);
        ...
        {
            // GIVEN
            var command = new TopRightRcsActivationCommand(true);

            // THEN
            var expectedTelemetry = new List<TelemetryMessage>
            {
                new TelemetryMessage("TopRightRcsActivated:True")
            };
        ...
        public void Should_provide_a_equality_by_value_method()
        {
            // GIVEN
            var commandA = new TopRightRcsActivationCommand(true);
            var commandB = new TopRightRcsActivationCommand(true);
            var commandC = new TopRightRcsActivationCommand(false);
