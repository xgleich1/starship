...
{
    public sealed class BottomRightFlapActuationCommandTest
    {
        [Test]
        public void Should_clamp_and_expose_the_commanded_deploy_percent()
        {
            // GIVEN
            var commandA = new BottomRightFlapActuationCommand(-0.1F);
            var commandB = new BottomRightFlapActuationCommand(0.0F);
            var commandC = new BottomRightFlapActuationCommand(0.5F);
            var commandD = new BottomRightFlapActuationCommand(1.0F);
            var commandE = new BottomRightFlapActuationCommand(1.1F);
        ...
        {
            // GIVEN
            var command = new BottomRightFlapActuationCommand(1.1F);

            // THEN
            var expectedTelemetry = new List<TelemetryMessage>
            {
                new TelemetryMessage("BottomRightFlapDeployPercent:1,1")
            };
        ...
        {
            // GIVEN
            var commandA = new BottomRightFlapActuationCommand(0.5F);
            var commandB = new BottomRightFlapActuationCommand(0.5F);
            var commandC = new BottomRightFlapActuationCommand(1.0F);
