...
{
    public sealed class ActuateBottomLeftFlapCommandTest
    {
        [Test]
        public void Should_expose_the_commanded_deploy_percent()
        {
            // GIVEN
            var command = new ActuateBottomLeftFlapCommand(0.5F);
        ...
        {
            // GIVEN
            var commandA = new ActuateBottomLeftFlapCommand(0.5F);
            var commandB = new ActuateBottomLeftFlapCommand(0.5F);
            var commandC = new ActuateBottomLeftFlapCommand(1.0F);
