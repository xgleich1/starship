...
{
    public sealed class ActuateTopLeftFlapCommandTest
    {
        [Test]
        public void Should_expose_the_commanded_deploy_percent()
        {
            // GIVEN
            var command = new ActuateTopLeftFlapCommand(0.5F);
        ...
        {
            // GIVEN
            var commandA = new ActuateTopLeftFlapCommand(0.5F);
            var commandB = new ActuateTopLeftFlapCommand(0.5F);
            var commandC = new ActuateTopLeftFlapCommand(1.0F);
        ...
        public void Should_provide_telemetry_containing_the_deploy_percent()
        {
            ...
            {
                new TelemetryMessage("TopLeftFlapDeployPercent:0,5")
            };
