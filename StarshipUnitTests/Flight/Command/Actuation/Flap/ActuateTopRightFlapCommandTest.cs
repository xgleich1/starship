...
{
    public sealed class ActuateTopRightFlapCommandTest
    {
        [Test]
        public void Should_expose_the_commanded_deploy_percent()
        {
            // GIVEN
            var command = new ActuateTopRightFlapCommand(0.5F);
        ...
        {
            // GIVEN
            var commandA = new ActuateTopRightFlapCommand(0.5F);
            var commandB = new ActuateTopRightFlapCommand(0.5F);
            var commandC = new ActuateTopRightFlapCommand(1.0F);
