...
{
    public sealed class PitchMainEnginesCommandTest
    {
        [Test]
        public void Should_expose_the_commanded_pitch_percent()
        {
            // GIVEN
            var command = new PitchMainEnginesCommand(0.5F);
        ...
        {
            // GIVEN
            var commandA = new PitchMainEnginesCommand(0.5F);
            var commandB = new PitchMainEnginesCommand(0.5F);
            var commandC = new PitchMainEnginesCommand(1.0F);
