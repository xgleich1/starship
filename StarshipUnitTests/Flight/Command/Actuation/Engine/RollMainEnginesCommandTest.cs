...
{
    public sealed class RollMainEnginesCommandTest
    {
        [Test]
        public void Should_expose_the_commanded_roll_percent()
        {
            // GIVEN
            var command = new RollMainEnginesCommand(0.5F);
        ...
        {
            // GIVEN
            var commandA = new RollMainEnginesCommand(0.5F);
            var commandB = new RollMainEnginesCommand(0.5F);
            var commandC = new RollMainEnginesCommand(1.0F);
