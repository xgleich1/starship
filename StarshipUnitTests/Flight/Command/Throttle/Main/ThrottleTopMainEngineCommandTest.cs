...
{
    public sealed class ThrottleTopMainEngineCommandTest
    {
        [Test]
        public void Should_expose_the_commanded_throttle_percent()
        {
            // GIVEN
            var command = new ThrottleTopMainEngineCommand(0.5F);
        ...
        {
            // GIVEN
            var commandA = new ThrottleTopMainEngineCommand(0.5F);
            var commandB = new ThrottleTopMainEngineCommand(0.5F);
            var commandC = new ThrottleTopMainEngineCommand(1.0F);
