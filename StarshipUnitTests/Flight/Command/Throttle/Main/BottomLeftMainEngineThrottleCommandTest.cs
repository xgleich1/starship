...
namespace StarshipUnitTests.Flight.Command.Throttle.Main
{
    public sealed class BottomLeftMainEngineThrottleCommandTest
    {
        ...
        {
            // GIVEN
            var throttleCommand = new BottomLeftMainEngineThrottleCommand(0.5F);
        ...
        [Test]
        public void Should_compare_two_equal_bottom_left_main_engine_throttle_commands()
        {
            // GIVEN
            var throttleCommandA = new BottomLeftMainEngineThrottleCommand(0.5F);
            var throttleCommandB = new BottomLeftMainEngineThrottleCommand(0.5F);
