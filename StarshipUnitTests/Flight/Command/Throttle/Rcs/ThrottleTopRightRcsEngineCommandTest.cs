...
{
    public sealed class ThrottleTopRightRcsEngineCommandTest
    {
        [Test]
        public void Should_expose_the_commanded_throttle_percent()
        {
            // GIVEN
            var command = new ThrottleTopRightRcsEngineCommand(0.5F);
        ...
        {
            // GIVEN
            var commandA = new ThrottleTopRightRcsEngineCommand(0.5F);
            var commandB = new ThrottleTopRightRcsEngineCommand(0.5F);
            var commandC = new ThrottleTopRightRcsEngineCommand(1.0F);
