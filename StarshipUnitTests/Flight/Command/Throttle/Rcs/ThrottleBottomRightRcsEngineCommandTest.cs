...
{
    public sealed class ThrottleBottomRightRcsEngineCommandTest
    {
        [Test]
        public void Should_expose_the_commanded_throttle_percent()
        {
            // GIVEN
            var command = new ThrottleBottomRightRcsEngineCommand(0.5F);
        ...
        {
            // GIVEN
            var commandA = new ThrottleBottomRightRcsEngineCommand(0.5F);
            var commandB = new ThrottleBottomRightRcsEngineCommand(0.5F);
            var commandC = new ThrottleBottomRightRcsEngineCommand(1.0F);
